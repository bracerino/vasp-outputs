...
PDOS_ORBITAL_COLS = {
    (3,  True):  {'s': (1, 2)},
    (7,  True):  {'s': (1, 2), 'p': (3, 4), 'd': (5, 6)},
    (9,  True):  {'s': (1, 2), 'py': (3, 4), 'pz': (5, 6), 'px': (7, 8)},
    (19, True):  {'s': (1, 2), 'py': (3, 4), 'pz': (5, 6), 'px': (7, 8),
                  'dxy': (9, 10), 'dyz': (11, 12), 'dz2': (13, 14),
                  'dxz': (15, 16), 'dx2-y2': (17, 18)},
